...
class TestPatientFactory(TestCase):
    ...
    def test_init(self):
        pfnc = PatientFactory(True, 5, ab_cnt, markers_list, cell_cnt, c_mu_list, c_sigma_list)
        pfc = PatientFactory(False, 5, ab_cnt, markers_list,  cell_cnt, nc_mu_list, nc_sigma_list)
